const data = [
	...
	},
	{
		id: 5,
		name: "Darjeeling",
		info: "Darjeeling is a picturesque hill station located in the Indian state of West Bengal. Known for its stunning tea gardens, Darjeeling offers breathtaking views of the Himalayas, including the iconic Kanchenjunga peak.Tourists flock to Darjeeling for its pleasant climate, scenic beauty, and opportunities for trekking, mountaineering.",
	...
	},
	{
		id: 6,
		name: "Jaisalmer",
		info: "Jaisalmer is a city in the Indian state of Rajasthan, known for its stunning sandstone architecture and its location in the heart of the Thar Desert. The city is home to several impressive palace, as well as unique cultural traditions.",
